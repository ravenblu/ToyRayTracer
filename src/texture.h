...
// This class uses the resulting image data parsed from stb_image.h
...
public:
    ...
    virtual color value(double u, double v, const vec3& p) const override {
        ...
        u = clamp(u, 0.0, 1.0);
        v = 1.0 - clamp(v, 0.0, 1.0); // flip V to image coordiates

        auto i = static_cast<int>(u * width);
        auto j = static_cast<int>(v * height);

        // Clamp integer mapping, since actual coordiates should be less than 1.0
